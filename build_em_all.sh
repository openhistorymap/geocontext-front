...
ng build mn-geo-layers-osm --prod    && cd dist/mn-layers-osm    && npm publish --access public && cd ../..
ng build mn-geo-layers-stamen --prod && cd dist/mn-layers-stamen && npm publish --access public && cd ../..
