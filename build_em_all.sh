...
ng build mn-geo-layers   #&& cd dist/mn-layers   && npm publish --access public && cd ../..
ng build mn-geo-layers-osm   #&& cd dist/mn-layers-osm   && npm publish --access public && cd ../..
ng build mn-geo-datasources   #&& cd dist/mn-datasources   && npm publish --access public && cd ../..
